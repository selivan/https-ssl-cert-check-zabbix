...
* `[domain for TLS SNI]` default is `<hostname or IP>`. *[TLS SNI](https://en.wikipedia.org/wiki/Server_Name_Indication) is used to specify certificate domain name, if it differs from hostname.*
